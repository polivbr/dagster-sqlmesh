...
class TestSQLMeshResourceCreation:
    ...
    def test_sqlmesh_resource_gateway(self) -> None:
        ...
        resource = SQLMeshResource(
            project_dir="tests/fixtures/sqlmesh_project", gateway="postgres"
        )
    ...
    def test_sqlmesh_resource_concurrency(self) -> None:
        ...
        resource = SQLMeshResource(
            project_dir="tests/fixtures/sqlmesh_project", concurrency_limit=4
        )
    ...
    def test_sqlmesh_resource_translator(self) -> None:
        ...
        resource = SQLMeshResource(
            project_dir="tests/fixtures/sqlmesh_project", translator=translator
        )
...
class TestSQLMeshResourceExecution:
    ...
    def test_sqlmesh_resource_execution(
    ...
    def test_sqlmesh_resource_materialization(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
    ...
    def test_sqlmesh_resource_get_recommended_schedule(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
    ...
    def test_sqlmesh_resource_validate_external_dependencies(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
    ...
    def test_create_failed_audit_check_result(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
        ...
        if result is not None:
            ...
            assert result.metadata["error_type"].value in [
                "audit_failure",
                "audit_extraction_failure",
            ]
    ...
    def test_create_general_error_check_result(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
    ...
    def test_deduplicate_asset_check_results(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
...
class TestSQLMeshResourceIntegration:
    ...
    def test_sqlmesh_resource_with_assets_factory(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
    ...
    def test_sqlmesh_resource_thread_safety(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
    ...
    def test_sqlmesh_resource_environment_variables(
...
class TestSQLMeshResourceErrorHandling:
    ...
    def test_sqlmesh_resource_network_errors(
        self, sqlmesh_resource: SQLMeshResource
    ) -> None:
