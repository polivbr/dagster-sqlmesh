...
class TestAssetUtils:
    ...
    def test_get_models_to_materialize_with_selection(self) -> None:
        ...
        result = get_models_to_materialize(
            selected_asset_keys, get_models_func, translator
        )
    ...
    def test_get_topologically_sorted_asset_keys(self) -> None:
        ...
        translator.get_asset_key.side_effect = lambda m: AssetKey(
            [m.catalog, m.schema_name, m.view_name]
        )
        ...
        result = get_topologically_sorted_asset_keys(
    ...
    def test_get_asset_tags(self) -> None:
        ...
        assert result == {"team:data": "true", "environment:prod": "true"}
    ...
    def test_safe_extract_audit_query_success(self) -> None:
        ...
        model.render_audit_query.return_value.sql.return_value = (
    ...
    def test_analyze_sqlmesh_crons_using_api(self) -> None:
        ...
        context.models = {"model1": model1, "model2": model2, "model3": model3}
    ...
    def test_validate_external_dependencies(self) -> None:
        ...
        sqlmesh_resource.translator = Mock()
        sqlmesh_resource.translator.get_external_dependencies.return_value = [
            "external.model1",
            "external.model2",
        ]
...
class TestAssetMetadata:
    ...
    def test_asset_metadata_includes_code_version_and_owners(self):
        ...
        md = get_asset_metadata(
            translator, M, code_version="abc", extra_keys=[], owners=["o"]
