...
class TestSQLMeshTranslator:
    ...
    def test_get_group_name_with_fallback_tag(self) -> None:
        ...
        group_name = translator.get_group_name_with_fallback(
            None, model, "default_group"
        )
    ...
    def test_get_tags(self) -> None:
        ...
        assert tags == {"team:data": "true", "environment:prod": "true"}
    ...
    def test_get_external_dependencies(self) -> None:
        ...
        context = Mock()
        model = Mock()
        model.depends_on = {"internal.model", "external.model1", "external.model2"}
...
class TestJinjaSQLMeshTranslator:
    ...
    def test_jinja_translator_creation(self) -> None:
        ...
        from dg_sqlmesh.components.sqlmesh_project.component import (
            JinjaSQLMeshTranslator,
        )
